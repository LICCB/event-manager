...
INSERT INTO LICCB.participants (participantID, partyID, eventID, firstName, lastName, phone, email, emergencyPhone, emergencyName, zip, isAdult, hasCPRCert, canSwim, boatExperience, boathouseDisc, eventDisc, regComments, regStatus, checkinStatus, volunteer, regTime, userComments, metadata)
    VALUES ('2c5ea4c0-4067-11e9-8bad-9b1deb4d3b7d', NULL, '123e4567-e89b-12d3-a456-556642440000', 'Timmy', 'Too', 
    '732-582-4952', 'timmytoo@gmail.com', '938-482-4859', 'Rob Lowe', '04853', 0, 0, 1, 0, 'Friend', 'Friend', NULL, 'Awaiting Confirmation',
    ...
    '838-238-5392', 'johnnyboy@yahoo.com', '829-482-5728', 'Chris Treager', '23842', 1, 1, 1, 1, 'Family', 'Email', NULL, 'Registered',
    ...
    '384-482-3952', 'hannabarbera@yahoo.com', '929-284-1935', 'Van Partible', '23905', 1, 0, 1, 1, 'Website', 'Facebook', NULL, 'Registered',
    ...
    '294-583-4910', 'brainboy@hotmail.com', '485-294-2910', 'Wesley Snipes', '93022', 0, 0, 1, 1, 'Website', 'Facebook', NULL, 'Registered',
    'Pending', 0, '2020-7-6 7:35:12', NULL, NULL),
    ('6cd3092f-72cb-4b53-b469-706e163917c9', NULL, '123e4567-e89b-12d3-a456-556642440000', 'Leslie', 'Knope', 
    '429-482-9532', 'leslieforpresident@aol.com', '930-392-4920', 'Ben Wyatt', '74292', 1, 1, 1, 1, 'Ad', 'Facebook', NULL, 'Registered',
...
INSERT INTO LICCB.participants (participantID, partyID, eventID, firstName, lastName, phone, email, emergencyPhone, emergencyName, zip, isAdult, hasCPRCert, canSwim, boatExperience, boathouseDisc, eventDisc, regComments, regStatus, checkinStatus, volunteer, regTime, userComments, metadata)
    ...
    '834-582-3292', 'founder@papajohns.com', '837-283-4810', 'Ceasar', '57293', 1, 0, 1, 0, 'Website', 'Facebook', NULL, 'Selected',
    ...
    '838-238-5392', 'johnnyman@gmail.com', '829-482-5728', 'Chris Treager', '23428', 1, 1, 1, 1, 'Family', 'Facebook', NULL, 'Standby',
    ...
    '923-349-0924', 'chris@pandr.com', '381-492-2430', 'Adam Scott', '23493', 1, 0, 1, 0, 'Co-worker', 'Email', NULL, 'Selected',
    ...
    '923-345-2939', 'crazynurse@gmail.com', '843-239-2394', 'Andy Dwyer', '23940', 1, 1, 1, 1, 'Website', 'Email', NULL, 'Selected',
    'Checked In', 0, '2020-1-3 20:37:29', NULL, NULL),
    ('3c1da2d1-113b-4c0b-9de8-08b24cca5f5d', NULL, 'db21ff8e-cf41-4261-9bbe-591eb5dbd862', 'Jerry', 'Gergich', 
    '201-129-4592', 'gary@pandr.com', '324-567-1392', 'Gayle Gergich', '40394', 1, 0, 1, 1, 'Website', 'Friend', NULL, 'Selected',
