$("#addpart").click(function () {
    ...
    var pLName = $(`<input   type="text" id="part${intId}lname" name="part${intId}lname" class="pname part${intId} partLName" partId=${intId} placeholder="Party Member Last Name Here"><br>`);
