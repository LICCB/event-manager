$("#addpart").click(function () {
    ...
    var pFName = $(`<input   type="text" id="part${intId}fname" name="part${intId}fname" class="name" placeholder="Party Member First Name Here"><br>`);
    var pLNameLabel = $(`<label for="part${intId}lname" >Participant ${intId} Last Name: </label>`);
    var pLName = $(`<input   type="text" id="part${intId}lname" name="part${intId}lname" class="pname part${intId}" partId=${intId} placeholder="Party Member Last Name Here"><br>`);
    ...
    var pEName = $(`<input   type="text" id="part${intId}ename" name="part${intId}ename" class="name" placeholder="Party Member Emergency Contact Name Here"/><br>`);
